...
import logo2 from "../assets/blogify.png"
 ...
 const Auth = () => {
    ...
    const handleRegister = ()=>{
        if (name && email && password){
            axios.post("http://localhost:8282/users/register", {username: name, email, password})
            ...
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    ...
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-3xl font-bold">Start giving your opignons </h3>
            ...
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    ...
                    <div className="relative">
                        ...
                        <p className="inline-block w-fit text-sm bg-white px-2 absolute -top-2 inset-x-0 mx-auto"> continue with</p>
                    </div>
                    <form
